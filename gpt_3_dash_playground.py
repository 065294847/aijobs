...
response = openai.Completion.create(model="curie:ft-qubit-2022-05-18-13-20-56", prompt=prompt_text0+delimiter0+prompt_text1+delimiter1+prompt_text2, temperature=0.7,
max_tokens=300,
top_p=1,
frequency_penalty=0,
presence_penalty=0)
