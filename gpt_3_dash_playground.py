...
prompt_text2 = st.text_input(label="Hvad er de vigtigste arbejdsopgaver og kompetence? Skriv gerne hele sætninger her, og gerne flere sætninger, så performer modellen bedre", value="Input")
