...
Original file is located at
    https://colab.research.google.com/drive/1OcfZIHOFOYdSonOCrT5VfstVMYjFEiGt
...
openai.api_key = "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"
...
def run_preset_01(query):
  ...
  response = openai.Completion.create(
    ...
    engine="curie:ft-qubit-2022-05-18-13-20-56",
...
app.layout = html.Div([
    ...
    dcc.Dropdown(
        id='dropdown-preset',
        options=[
            {'label': 'Generer jobopslag', 'value': '01'},
